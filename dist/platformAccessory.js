...
class DeskAccessory {
    ...
    poll() {
        if (!this.isMoving && !this.isPolling && !this.currentlyRequestingMove) {
            ...
            this.currentPollProcess = (0, child_process_1.exec)(pollcommand, (error, stdout, stderr) => {
                if (stderr) {
                    this.isPolling = false;
                ...
                if (stdout) {
                    try {
                        ...
                        const height_rel = this.HeightToPercentage(+heightStr);
    ...
    async moveToPercent(percentage) {
        var _a;
        ...
        this.isMoving = true;
        (_a = this.currentPollProcess) === null || _a === void 0 ? void 0 : _a.kill('SIGINT');
        this.currentPollProcess = null;
        this.currentMoveProcess = (0, child_process_1.exec)(moveCommand, (error, stdout, stderr) => {
            if (stderr) {
...
exports.DeskAccessory = DeskAccessory;
